...
- **IDE**: Eclipse IDE for Java Developers (recommended) or VScode
...
The projects codebase is divided into distinct logical packages, each assigned a unique responsibility. This modular structure promotes a clear separation of concerns and leads to better organization of the code.
...
**Author**: Astitva Srivastava<br> 
**Reg. No.**: 24BCE10038<br>
